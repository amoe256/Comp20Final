...
function printToPage() {
    ...
    listSong += "<div class='here'><h1 >Your " + data.genre + "Tracks!</h1></div><br>";
      for (i = 0; i < 10; i++) {
        if (i %2 == 0) {
        listSongs += "<div class='row'><div class='col-sm-3' style='background-color:white;'>";
        listSongs += "<audio id='audioID"+i+"'><source src='" + data.playsong + "' type='audio/mpeg'></audio>";
        listSongs += "<a href='#' onmouseenter='playAudio("+i+")'onmouseout='stopAudio("+i+")' onclick='playAudio("+i+")'><img src='" + data.image + "'";
